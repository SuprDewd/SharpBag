...
namespace SharpBag.Math.ForInt32
{
	...
	public class Polynomial
	{
		...
		public int this[int i]
		{
			...
			set
			{
				if (i >= this.Coefficients.Length)
				{
					...
					Array.Resize<int>(ref this.Coefficients, i + 1);
					for (int j = old; j < i; j++)
					{
		...
		{
			int[] added = new int[left.Coefficients.Length > right.Coefficients.Length ? left.Coefficients.Length : right.Coefficients.Length];
		...
		public static Polynomial operator -(Polynomial left, Polynomial right)
		{
			int[] subtracted = new int[left.Coefficients.Length > right.Coefficients.Length ? left.Coefficients.Length : right.Coefficients.Length];
		...
		{
			int[] negated = new int[value.Coefficients.Length];
		...
		public static Polynomial operator *(Polynomial left, Polynomial right)
		{
			...
			int[] multiplied = new int[newLength];
		...
		private static Polynomial OfDegree(int degree, int coefficient)
		{
		...
		public static implicit operator Polynomial(int n)
		{
		...
		{
			int[] coefficients = new int[this.Degree];
