...
namespace SharpBag.Math.ForBigInteger
{
	...
	/// A vector.
	/// </summary>
	public class Vector : VectorBase<BigInteger, Vector>
	{
		#region Properties
		...
		/// Gets the length.
		/// </summary>
		public override BigInteger Length
		{
			get
			{
				BigInteger sum = 0;
		...
		public override Vector Reverse
		{
			get
			{
				...
				VectorBase<BigInteger, Vector>.InternalReverse(result, this);
				return result;
			}
		}
		...
		public Vector(BigInteger[] elements) : base(elements) { }
		...
		/// <summary>
		/// Performs an implicit conversion from an array of numbers to <see cref="SharpBag.Math.ForBigInteger.Vector"/>.
		/// </summary>
		/// <param name="elements">The elements.</param>
		/// <returns>
		/// The result of the conversion.
		/// </returns>
		public static implicit operator Vector(BigInteger[] elements) { return new Vector(elements); }

		/// <summary>
		/// Performs an implicit conversion from <see cref="SharpBag.Math.ForBigInteger.Vector"/> to an array of numbers.
		/// </summary>
		/// <param name="vector">The vector.</param>
		/// <returns>
		/// The result of the conversion.
		/// </returns>
		public static implicit operator BigInteger[](Vector vector) { return vector.Elements; }
		...
		/// The result of the operator.
		/// </returns>
		public static Vector operator *(Vector left, BigInteger right) { return Vector.Multiply(left, right); }
		...
		/// The result of the operator.
		/// </returns>
		public static Vector operator *(BigInteger left, Vector right) { return Vector.Multiply(left, right); }
		...
		/// <param name="right">The right number.</param>
		/// <returns>The result.</returns>
		public static Vector Multiply(Vector left, BigInteger right)
		{
			Vector result = new Vector(left);
		...
		/// <param name="right">The right vector.</param>
		/// <returns></returns>
		public static Vector Multiply(BigInteger left, Vector right) { return Vector.Multiply(right, left); }
		...
		public static BigInteger DotProduct(Vector left, Vector right)
		{
			Contract.Requires(left.Dimension == right.Dimension);
			BigInteger sum = 0;
		...
		public static Vector CrossProduct(Vector left, Vector right)
		{
			...
			return new BigInteger[] { -left[2] * right[1] + left[1] * right[2], left[2] * right[0] - left[0] * right[2], -left[1] * right[0] + left[0] * right[1] };
		}
		...
		public Matrix ToColumnMatrix()
		{
			...
			VectorBase<BigInteger, Vector>.InternalToColumnMatrix(result, this);
			return result;
		}
		...
		public Matrix ToRowMatrix()
		{
			...
			VectorBase<BigInteger, Vector>.InternalToRowMatrix(result, this);
			return result;
		}
		...
		/// </returns>
		public override bool Equals(Vector other) { return VectorBase<BigInteger, Vector>.InternalEquals(this, other); }
