...
namespace SharpBag.Math.ForFraction.ForInt64
{
    ...
    public class Vector : VectorBase<Fraction, Vector>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="SharpBag.Math.ForFraction.ForInt64.Vector"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SharpBag.Math.ForFraction.ForInt64.Vector"/> to an array of numbers.
        /// </summary>
