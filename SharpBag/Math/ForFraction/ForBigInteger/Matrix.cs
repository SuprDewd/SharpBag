...
namespace SharpBag.Math.ForFraction.ForBigInteger
{
	...
	public class Matrix : MatrixBase<Fraction, Matrix>
	{
		...
		public abstract class Accessor : IEnumerable<Vector>
		{
			...
			/// <summary>
			/// Gets or sets the <see cref="SharpBag.Math.ForFraction.ForBigInteger.Vector"/> at the specified index.
			/// </summary>
		...
		/// <summary>
		/// Performs an implicit conversion from an array of numbers to <see cref="SharpBag.Math.ForFraction.ForBigInteger.Matrix"/>.
		/// </summary>
		/// <param name="elements">The elements.</param>
		/// <returns>
		...
		/// <summary>
		/// Performs an implicit conversion from <see cref="SharpBag.Math.ForFraction.ForBigInteger.Matrix"/> to an array of numbers.
		/// </summary>
		/// <param name="matrix">The matrix.</param>
		/// <returns>
		/// The result of the conversion.
		...
		/// <summary>
		/// Performs an explicit conversion from <see cref="SharpBag.Math.ForFraction.ForBigInteger.Matrix"/> to <see cref="SharpBag.Math.ForFraction.ForBigInteger.Vector"/>.
		/// </summary>
		/// <param name="matrix">The matrix.</param>
		/// <returns>
		/// The result of the conversion.
