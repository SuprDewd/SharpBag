...
namespace SharpBag.Math.ForInt64
{
	...
	/// A vector.
	/// </summary>
	public class Vector : VectorBase<long, Vector>
	{
		#region Properties
		...
		public override Vector Reverse
		{
			get
			{
				...
				VectorBase<long, Vector>.InternalReverse(result, this);
				return result;
			}
		}
		...
		public Vector(long[] elements) : base(elements) { }
		...
		/// <summary>
		/// Performs an implicit conversion from an array of numbers to <see cref="SharpBag.Math.ForInt64.Vector"/>.
		/// </summary>
		/// <param name="elements">The elements.</param>
		/// <returns>
		/// The result of the conversion.
		/// </returns>
		public static implicit operator Vector(long[] elements) { return new Vector(elements); }

		/// <summary>
		/// Performs an implicit conversion from <see cref="SharpBag.Math.ForInt64.Vector"/> to an array of numbers.
		/// </summary>
		/// <param name="vector">The vector.</param>
		/// <returns>
		/// The result of the conversion.
		/// </returns>
		public static implicit operator long[](Vector vector) { return vector.Elements; }
		...
		/// The result of the operator.
		/// </returns>
		public static Vector operator *(Vector left, long right) { return Vector.Multiply(left, right); }
		...
		/// The result of the operator.
		/// </returns>
		public static Vector operator *(long left, Vector right) { return Vector.Multiply(left, right); }
		...
		/// <param name="right">The right number.</param>
		/// <returns>The result.</returns>
		public static Vector Multiply(Vector left, long right)
		{
			Vector result = new Vector(left);
		...
		/// <param name="right">The right vector.</param>
		/// <returns></returns>
		public static Vector Multiply(long left, Vector right) { return Vector.Multiply(right, left); }
		...
		public static long DotProduct(Vector left, Vector right)
		{
			Contract.Requires(left.Dimension == right.Dimension);
			long sum = 0;
		...
		public static Vector CrossProduct(Vector left, Vector right)
		{
			...
			return new long[] { -left[2] * right[1] + left[1] * right[2], left[2] * right[0] - left[0] * right[2], -left[1] * right[0] + left[0] * right[1] };
		}
		...
		public Matrix ToColumnMatrix()
		{
			...
			VectorBase<long, Vector>.InternalToColumnMatrix(result, this);
			return result;
		}
		...
		public Matrix ToRowMatrix()
		{
			...
			VectorBase<long, Vector>.InternalToRowMatrix(result, this);
			return result;
		}
		...
		/// </returns>
		public override bool Equals(Vector other) { return VectorBase<long, Vector>.InternalEquals(this, other); }
